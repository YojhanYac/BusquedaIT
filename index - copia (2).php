                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="addPanel" name="form" method="post">
                            ...
                            <input type="text" id="nivel" name="nivel"><br>
                            <label for="remuneracion">remuneracion</label>
                            <input type="text" id="remuneracion" name="remuneracion"><br>
                            <label for="habilidadesTecnicas">habilidadesTecnicas</label>
                            <input type="text" id="habilidadesTecnicas" name="habilidadesTecnicas"><br>
                            <label for="habilidadesBlandas">habilidadesBlandas</label>
                            <input type="text" id="habilidadesBlandas" name="habilidadesBlandas"><br>      
                ...
                <div class="card" style="width: auto; margin: 0.25% 0.4%;">
                    ...
                    foreach($buff as $name => $value){
                        ...
                        if ($arrayIndex == 9) {
                            ...
                            <div class="modal fade" id="<?php echo "btnId_" . $arrayData[0]; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo "btnId_" . $arrayData[0] ."Label"; ?>" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <form class="editPanel" name="form" method="post">
                                                ...
                                                <label for="nombre">Nombre</label>
                                                <input type="text" class="nombre" name="nombre" value="<?php echo $arrayData[1];?>"><br>
                                                <label for="empresa">empresa</label>
                                                <input type="text" class="empresa" name="empresa" value="<?php echo $arrayData[2];?>"><br>
                                                <label for="nivel">nivel</label>
                                                <input type="text" class="nivel" name="nivel" value="<?php echo $arrayData[3];?>"><br>
                                                <label for="remuneracion">remuneracion</label>
                                                <input type="text" class="remuneracion" name="remuneracion" value="<?php echo $arrayData[4];?>"><br>
                                                <label for="habilidadesTecnicas">habilidadesTecnicas</label>
                                                <input type="text" class="habilidadesTecnicas" name="habilidadesTecnicas" value="<?php echo $arrayData[5];?>"><br>
                                                <label for="habilidadesBlandas">habilidadesBlandas</label>
                                                <input type="text" class="habilidadesBlandas" name="habilidadesBlandas" value="<?php echo $arrayData[6];?>"><br>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btnClose">Close</button>
                        ...
                        if($name == "nombre" || $name == "habilidadesTecnicas"){
                            if($count == 1 ){?>
                                ...
                                <div style="margin: 0px 0px; display:inline-block;width: auto; margin-right: 4%;"><?php echo $value; ?></div>
                                <div style="width: 10%; min-width:200px;">
                                    <button type="buttom" style="width: 50%;" data-toggle="modal" data-target="<?php echo "#btnId_" . $arrayID; ?>">Editar</button>
                                    <button style="width: 50%;">Eliminar</button>
                                </div><?php
                                ...
                                <div style="margin: 0px 0px; width: auto; min-width: 150px;display:inline-block; margin-right: 4%;"><?php
                                    echo $value; ?>
                                </div><?php
